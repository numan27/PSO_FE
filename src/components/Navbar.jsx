        ...
        <div className="bg_primary text-white header">
            <Container fluid className="px-xl-5 px-3">
                <Row className="py-4 d-flex justify-content-between">
                    ...
                    <Col xl={6} className="d-flex flex-column align-items-end justify-content-xl-end justify-content-center ps-xl-5">
                        {isLoggedIn && (
                            <div className="">
                                <Button className="d-flex align-items-center justify-content-center px-3" variant="outline-light" onClick={handleSignOut}>
